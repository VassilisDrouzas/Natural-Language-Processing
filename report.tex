...
\begin{document}
	...
	Regarding the spell correction, we cite an example of our bi-gram model corrector in Figures \ref{fig::spell_check_example_bigram} \& \ref{fig::spell_check_example_trigram}.
