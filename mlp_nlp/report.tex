...
\begin{document}
    ...
    Now, it’s time to define our MLP model. We used the SGD algorithm since for this case it provided better results than Adam. The number of epochs was set to 50. We experimented with a variety of different hyperparameter combinations (Table \ref{tab::ex-9-stats}).
...
\begin{table}
    ...
    \hline
    0.1 & 3 & 256 & & 64 \\
   \cline{5-5} % specifying only the last column
    & & & & 128 \\
    \cline{5-5} % specifying only the last column
