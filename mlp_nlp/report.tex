...
\begin{document}
	...
	Thus, besides quantitative statistics such as cross accuracy and f1-score, we should pay close attention to the precision and recall statistics for the more variable POS tags such as "NOUN" or "VERB" in order to properly validate our MLP classifier.
